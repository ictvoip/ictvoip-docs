...
Step 1: Upload Installation Folders
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The FusionPBX API and theme files are distributed in the ``fpbx_apis-theme``
folder included in the FusionPBX ZIP download.

1. Extract the FusionPBX package on your local machine.
2. Upload the following folders to ``/root/`` on each FusionPBX server:
...
::
    ...
    # Example: After uploading, you should have:
    /root/ictvoip_fpbx5-3_apis/
    /root/ictvoip_fpbx5-3_theme/

Step 2: Run the API Installer Script
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Step 3: Install Theme Customizations (Optional)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
